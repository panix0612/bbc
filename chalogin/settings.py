"""
Django settings for chalogin project.
...
SECRET_KEY = 'django-insecure-to)*qtw5247*pmah-n*v0!57ake9*%4_+726&=^i@j!+!mw8t('
...
WSGI_APPLICATION = 'chalogin.wsgi.application'
